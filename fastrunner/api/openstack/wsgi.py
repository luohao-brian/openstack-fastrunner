...
from fastrunner.api.openstack import api_version_request as api_version
from fastrunner.api.openstack import versioned_method
from fastrunner import exception
from fastrunner import i18n
from fastrunner.i18n import _
from fastrunner.i18n import _LE
from fastrunner.i18n import _LI
...
class Request(wsgi.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'fastrunner.best_content_type' not in self.environ:
            ...
            self.environ['fastrunner.best_content_type'] = (content_type or
                                                      'application/json')

        return self.environ['fastrunner.best_content_type']
...
class Resource(wsgi.Application):
    ...
    def _process_stack(self, request, action, action_args,
        ...
        context = request.environ.get('fastrunner.context')
