...
import fastrunner.conf
from fastrunner import exception
from fastrunner.i18n import _, _LE, _LI
from fastrunner import utils

CONF = fastrunner.conf.CONF
...
class Server(service.ServiceBase):
    ...
    def __init__(self, name, app, host='0.0.0.0', port=0, pool_size=None,
        ...
        self._logger = logging.getLogger("fastrunner.%s.wsgi.server" % self.name)
...
class Application(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = fastrunner.api.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import fastrunner.api.fancy_api
...
class Middleware(Application):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = fastrunner.api.analytics:Analytics.factory

        which would result in a call to the `Analytics` class as

            import fastrunner.api.analytics
...
class Loader(object):
    ...
    def load_app(self, name):
        ...
        :raises: `fastrunner.exception.PasteAppNotFound`
