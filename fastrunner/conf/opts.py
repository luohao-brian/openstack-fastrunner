...
* the fastrunner.conf package doesn't have further packages with config options
...
def _import_modules(module_names):
    ...
    for modname in module_names:
        mod = importlib.import_module("fastrunner.conf." + modname)
        if not hasattr(mod, LIST_OPTS_FUNC_NAME):
            msg = "The module 'fastrunner.conf.%s' should have a '%s' "\
