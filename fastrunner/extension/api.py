...
from fastrunner import db as ext_db
from fastrunner import exception as ext_exception
...
#        self.compute_rpcapi = compute_rpcapi.ComputeAPI()
    ...
    def get_all_test(self, context, search_opts=None, limit=None, marker=None,
                want_objects=False, expected_attrs=None, sort_keys=None,
                sort_dirs=None):
 ...
 #           check_policy(context, "get_all", target)
        ...
        instances = ext_db.instance_get_all_test(context)
